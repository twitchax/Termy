...
kubectl create secret generic termy-secrets --namespace termy-terminals --from-file=.hidden/supw --from-file=.hidden/tls.crt --from-file=.hidden/tls.key
